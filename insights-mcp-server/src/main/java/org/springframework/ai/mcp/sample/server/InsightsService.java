...
public class InsightsService {
	...
	/**
	 * recommendations search for entities (places, media, people, ...) in specific latitude/longitude either similar either meeting special criteria
	 ...
	 */
	@Tool(description = "recommendations search for entities (places, media, people, ...) in specific latitude/longitude either similar either meeting special criteria")
